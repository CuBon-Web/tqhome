...
Route::group(['namespace'=>'Api','middleware' => 'api'],function(){
	...
	Route::post('upload-video','AllController@uploadVideo');
...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'website','namespace'=>'Website'], function(){
		...
		Route::post('history-milestone','HistoryMilestoneController@createOrUpdate')->middleware('rbac.permission:website.update');
		Route::get('list-history-milestone','HistoryMilestoneController@list')->middleware('rbac.permission:website.view');
		...
		Route::get('list-product-profile','ProductProfileController@listCategories')->middleware('rbac.permission:website.view');
		Route::post('product-profile-category','ProductProfileController@saveCategory')->middleware('rbac.permission:website.update');
		Route::get('product-profile-category/{id}','ProductProfileController@getCategory')->middleware('rbac.permission:website.view');
		Route::get('product-profile-category/delete/{id}','ProductProfileController@deleteCategory')->middleware('rbac.permission:website.update');
		Route::post('product-profile-documents/{categoryId}','ProductProfileController@saveDocuments')->middleware('rbac.permission:website.update');
	});
