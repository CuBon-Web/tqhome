...
let _routers = [
            ...
            },
            {
                name: 'coreValue',
                path: '/core-value',
                component: _import('website/coreValue'),
                meta: { requiresAuth: true },
            },
            {
                name: 'historyMilestone',
                path: '/history-milestone',
                component: _import('website/historyMilestone'),
                meta: { requiresAuth: true },
            },
            {
                name: 'processStep',
            ...
            },
            {
                ...
                component: _import('website/productProfile/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/product-profile/add',
                component: _import('website/productProfile/add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/product-profile/edit/:id',
                component: _import('website/productProfile/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/product-profile/:id/documents',
                component: _import('website/productProfile/documents'),
                meta: {
                    requiresAuth: true,
                }
            },
